...
<br><br><br><br><br><br>
<form action="${pageContext.request.contextPath}/member/injeung.do?dice=${dice}&email=${email}" method="post">
			  ...
			  <label class="email">
               ...
               style="border:0; background-color:white; width:150px;">인증번호 입력</button>
</form>
