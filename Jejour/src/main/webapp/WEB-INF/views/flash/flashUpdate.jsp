...
<!DOCTYPE html>
          ...
          <div class="col-md-8 ftco-animate mx-auto">
            <form action="${pageContext.request.contextPath}/flashBoard/flashBoardUpdate.fl" method="post">
			    ...
			    <div id="menu_wrap" class="bg_white">
		        	<div class="option">
			            ...
			            <!-- form에서 div로 변경 작업
		                 ...
		                 -->
            			    <div>
			                              키워드 : <input type="text" value="${FlashBoard.FMapTitle}" id="keyword" size="15"> 
              ...
              <div style="text-align: center;">
                ...
                &nbsp;&nbsp;
                <input type="button" class="search-submit btn btn-primary" value="삭제하기" onclick="goFlashDelete();">
                &nbsp;&nbsp;
    ...
    <script>
	    ...
	    function goFlashDelete(){
	    	location.href = "${pageContext.request.contextPath}/flashBoard/flashBoardDelete.fl?fNo=${FlashBoard.FNo}";
	    }
    </script>
