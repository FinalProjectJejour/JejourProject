        ...
        <div class="row">
          <div class="col-md-8 ftco-animate mx-auto">
            <form action="">
              <!-- 제목이 들어갈 부분 -->
              <h2 class="mb-3">
                <label style="width: 15%;">제목 :</label><input type="text" name="first_name" placeholder="제목을 입력해주세요." onfocus="this.placeholder = ''" onblur="this.placeholder = '제목을 입력하시라닌깐요!'" required="" class="single-input">
              </h2>
              <br>
              <p>
                <img src="images/wysiwyg.JPG" alt="" class="img-fluid">
              </p>
              <br>
