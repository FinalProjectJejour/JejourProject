...
<!DOCTYPE html>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row ftco-animate" id="plannerBest">
        </div>
      </div>
    </section>
    ...
    <script>
    	$(function(){
    		$.ajax({
    			url : '${pageContext.request.contextPath}/planner/plannerBest.do',
    			type : 'get',
    			success : function(list){
    				console.log("성공!");
    				$('#plannerBest').append('<div class="carousel1 owl-carousel ftco-owl"></div>');

					for(var i in list){
						if(list[i].renamedFileName != null){
	    					$('.carousel1').append(
	    					          '<div class="item">' +
	    					            '<div class="blog-entry">' +
	    					              ...
	    					              '<div class="text p-4">' +
	    					                '<div class="meta">' +
	    					                  '<div><a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '">' + list[i].startDay + '</a></div>' +
	    					                  '<div><a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '">~</a></div>' +
	    					                  '<div><a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '">' + list[i].endDay + '</a></div>' +
	    					                '</div>' +
	    					                '<div class="meta">' +
	    					                  '<div><a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '">' + '작성자 :' + list[i].pwriter + '</a></div>' +
	    					                '</div>' +
	    					                '<div style="height: 120px;">' +
	    					                	'<h3 class="heading"><a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '">' + list[i].title + '</a></h3>' +
	    					                '</div>' +
	    					                '<p class="clearfix">' +
	    					                  '<a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '" class="float-left">Read more</a>' +
	    					                  '<a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '" class="float-right meta-chat"><span class="icon-thumbs-o-up"></span>' + '&nbsp;' + list[i].likeCount + '</a>' +
	    					                '</p>' +
	    					              '</div>' +
	    					            '</div>' +
	    					          '</div>'
	    					...
	    					$('.carousel1').append(
	    					          '<div class="item">' +
	    					            '<div class="blog-entry">' +
	    					              '<a href="${pageContext.request.contextPath}/planner/maintenanceGo.do?pNo=' + list[i].pno + '" class="block-20" style="background-image: url(' + '\'' + '${pageContext.request.contextPath}/resources/images/noimage.jpg' + '\'' + '); text-align: right;">' +
	    					                '<div class="col-sm-4" style="text-align: center; background-color: #ff5f5f; color : white;">' +
	    					                  	list[i].theme +
	    					                '</div>' +
	    					              '</a>' +
