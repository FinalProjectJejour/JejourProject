...
<html lang="en">
  ...
  <body>
  	<c:set var="reservationPage" value="window.open('${pageContext.request.contextPath}/planner/reservationGo.do', 'reservationPage', 'width=1000,height=800');"/>
            ...
            <form action="${pageContext.request.contextPath}/plannerPart/instanceMakePlan.do" id="makingPlan" method="post" onsubmit="return pass();">
              ...
              <c:if test="${no ne null or pNo ne null }">
	              <div class="form-group" style="float:right">
	                <button type="button" class="btn btn-primary py-3 px-4" onclick="save();">+일정</button>
	              </div>
              </c:if>
            </form>
          </div>
